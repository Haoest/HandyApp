...
/// Two-step quick-log flow reached from the Timeline's "+ Log": pick the thing, then the kind.
/// The third step is the existing event/transaction edit sheet.
...
private struct QuickLogSheet: View {
    ...
    private var stepTitle: String {
        switch step {
        case .pickThing: return String(localized: "Log something")
        case .pickKind: return String(localized: "What kind?")
        }
    }
