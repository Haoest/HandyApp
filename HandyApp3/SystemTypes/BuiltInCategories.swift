    ...
    static let categoryTemplates: [SystemCategory: [PropertyDefinition]] = {
        ...
        return [
            .residentialHousing: [
                ...
                PropertyDefinition(id: deterministicID("field.residentialHousing.Lot Size"),           name: "Lot Size",           type: .basic(.text),   isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Year Built"),         name: "Year Built",         type: .basic(.number), isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Tax ID"),             name: "Tax ID",             type: .basic(.text),   isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Gas Provider"),       name: "Gas Provider",       type: .basic(.text),   isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Water Provider"),     name: "Water Provider",     type: .basic(.text),   isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Electricity Provider"), name: "Electricity Provider", type: .basic(.text), isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Roof"),               name: "Roof (material, year, expected lifespan)", type: .basic(.text), isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Home Insurance"),     name: "Home Insurance",     type: .basic(.text),   isRequired: false),
                PropertyDefinition(id: deterministicID("field.residentialHousing.Mortgage Lender"),    name: "Mortgage Lender",    type: .basic(.text),   isRequired: false),
            ],
            .rentalHome: [
                ...
                PropertyDefinition(id: deterministicID("field.rentalHome.Lot Size"),           name: "Lot Size",           type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Year Built"),         name: "Year Built",         type: .basic(.number),  isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Tax ID"),             name: "Tax ID",             type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Gas Provider"),       name: "Gas Provider",       type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Water Provider"),     name: "Water Provider",     type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Electricity Provider"), name: "Electricity Provider", type: .basic(.text), isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Rental License"),     name: "Rental License",     type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Roof"),               name: "Roof (material, year, expected lifespan)", type: .basic(.text), isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Landlord Insurance"), name: "Landlord Insurance", type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Mortgage Lender"),    name: "Mortgage Lender",    type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Smoke Detector"),     name: "Smoke Detector",     type: .basic(.text),    isRequired: false),
                PropertyDefinition(id: deterministicID("field.rentalHome.Property Manager"),   name: "Property Manager",   type: .basic(.contact), isRequired: false),
            ],
            .automobile: [
